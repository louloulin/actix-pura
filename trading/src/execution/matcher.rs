...
mod tests {
    ...
    fn test_match_market_orders() {
        ...
        // Previous assertion was failing with left=13.0 and right=8.0
        println!("\nAbout to assert remaining_quantity: expected 13.0, got {}", remaining_sell.remaining_quantity());
        assert_eq!(remaining_sell.remaining_quantity(), 13.0);
    }
