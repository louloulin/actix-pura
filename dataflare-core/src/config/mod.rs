...
// Deserializador personalizado para LevelFilter
fn deserialize_level_filter<'de, D>(deserializer: D) -> std::result::Result<LevelFilter, D::Error>
where
    D: Deserializer<'de>,
{
    ...
    match s.to_uppercase().as_str() {
        ...
        _ => Ok(LevelFilter::Info), // Valor por defecto
    }
}
...
pub struct DataFlareConfig {
    ...
    /// Nivel de logging
    #[serde(serialize_with = "serialize_level_filter", deserialize_with = "deserialize_level_filter")]
